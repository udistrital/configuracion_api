...
func (m *CrearTablaMetodoHttp_20191114_143538) Up() {
	...
	m.SQL("CREATE TABLE IF NOT EXIST configuracion.metodo_http ( id serial NOT NULL, nombre character varying NOT NULL, descripcion character varying NOT NULL, CONSTRAINT pk_metodo_http PRIMARY KEY (id) );")
