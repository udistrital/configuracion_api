...
func (m *CrearTablaPerfil_20191114_144511) Up() {
	...
	m.SQL("CREATE TABLE IF NOT EXISTS configuracion.perfil ( id serial NOT NULL, nombre character varying(50) NOT NULL, aplicacion integer NOT NULL, CONSTRAINT PK_PERFIL PRIMARY KEY (id), CONSTRAINT FK_PERFIL_APP FOREIGN KEY (aplicacion) REFERENCES configuracion.aplicacion (id) );")
